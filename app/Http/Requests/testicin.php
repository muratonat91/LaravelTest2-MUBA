...
class testicin extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'images.*' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048000', // Example for image validation
            'images' => 'array|min:1', // Ensure at least one image is provided
        ];
    }
